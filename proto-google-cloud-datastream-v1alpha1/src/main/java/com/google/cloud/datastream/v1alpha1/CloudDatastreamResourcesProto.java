...
public final class CloudDatastreamResourcesProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ";google/cloud/datastream/v1alpha1/datastream_resources.proto\022 google.cloud.data"
          ...
          + "obuf/timestamp.proto\032\034google/api/annotations.proto\"\250\002\n\r"
          ...
          + "\025connection_attributes\030\006 \003(\0132I.google.cloud.datastream."
          + "v1alpha1.OracleProfile.ConnectionAttributesEntry\032;\n"
          ...
          + "ssl_config\030\005 \001(\01320.google.cloud.datastream.v1alpha1.MysqlSslConfig\"9\n\n"
          + "GcsProfile\022\030\n"
          + "\013bucket_name\030\001 \001(\tB\003\340A\002\022\021\n"
          ...
          + ".google.cloud.datastream.v1alpha1.PrivateConnection.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022M\n"
          + "\005state\030\006 \001(\01629.google.cloud"
          + ".datastream.v1alpha1.PrivateConnection.StateB\003\340A\003\022;\n"
          + "\005error\030\007"
          + " \001(\0132\'.google.cloud.datastream.v1alpha1.ErrorB\003\340A\003\022N\n"
          + "\022vpc_peering_config\030d"
          + " \001(\01322.google.cloud.datastream.v1alpha1.VpcPeeringConfig\032-\n"
          ...
          + "+datastream.googleapis.com/PrivateConnection\022"
          + "Oprojects/{project}/locations/{location}/privateConnections/{private_connection}\";\n"
          + "\023PrivateConnectivity\022$\n"
          + "\027private_connection_name\030\001 \001(\tB\003\340A\002\"\331\003\n"
          + "\005Route\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\0224\n"
          + "\013create_time\030\002 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0224\n"
          + "\013update_time\030\003 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022C\n"
          + "\006labels\030\004"
          + " \003(\01323.google.cloud.datastream.v1alpha1.Route.LabelsEntry\022\031\n"
          ...
          + "\037datastream.googleapis.com/Route\022^projects/{project}/locations/{locatio"
          + "n}/privateConnections/{private_connection}/routes/{route}\"\312\001\n"
          ...
          + "ud.datastream.v1alpha1.ConnectionProfile.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022I\n"
          + "\016oracle_profile\030d"
          + " \001(\0132/.google.cloud.datastream.v1alpha1.OracleProfileH\000\022C\n"
          + "\013gcs_profile\030e"
          + " \001(\0132,.google.cloud.datastream.v1alpha1.GcsProfileH\000\022G\n\r"
          + "mysql_profile\030f"
          + " \001(\0132..google.cloud.datastream.v1alpha1.MysqlProfileH\000\022T\n"
          + "\017no_connectivity\030\310\001 \001"
          + "(\01328.google.cloud.datastream.v1alpha1.NoConnectivitySettingsH\001\022h\n"
          + "\036static_service_ip_connectivity\030\311\001 \001(\0132=.google.cloud.d"
          + "atastream.v1alpha1.StaticServiceIpConnectivityH\001\022c\n"
          + "\030forward_ssh_connectivity\030\312\001 "
          + "\001(\0132>.google.cloud.datastream.v1alpha1.ForwardSshTunnelConnectivityH\001\022V\n"
          + "\024private_connectivity\030\313\001"
          + " \001(\01325.google.cloud.datastream.v1alpha1.PrivateConnectivityH\001\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\201\001\352A~\n"
          + "+datastream.googleapis.com/ConnectionProfile\022Oprojects/{project}/loca"
          + "tions/{location}/connectionProfiles/{connection_profile}B\t\n"
          + "\007profileB\016\n"
          ...
          + "\016oracle_columns\030\002"
          + " \003(\0132..google.cloud.datastream.v1alpha1.OracleColumn\"i\n"
          + "\014OracleSchema\022\023\n"
          + "\013schema_name\030\001 \001(\t\022D\n\r"
          + "oracle_tables\030\002 \003(\0132-.google.cloud.datastream.v1alpha1.OracleTable\"U\n"
          + "\013OracleRdbms\022F\n"
          + "\016oracle_schemas\030\001"
          + " \003(\0132..google.cloud.datastream.v1alpha1.OracleSchema\"\231\001\n"
          + "\022OracleSourceConfig\022@\n"
          + "\tallowlist\030\001 \001(\0132-.google.cloud.datastream.v1alpha1.OracleRdbms\022A\n\n"
          + "rejectlist\030\002 "
          + "\001(\0132-.google.cloud.datastream.v1alpha1.OracleRdbms\"\231\001\n"
          ...
          + "mysql_columns\030\002 \003(\0132-.google.cloud.datastream.v1alpha1.MysqlColumn\"j\n\r"
          + "MysqlDatabase\022\025\n\r"
          + "database_name\030\001 \001(\t\022B\n"
          + "\014mysql_tables\030\002"
          + " \003(\0132,.google.cloud.datastream.v1alpha1.MysqlTable\"V\n\n"
          + "MysqlRdbms\022H\n"
          + "\017mysql_databases\030\001"
          + " \003(\0132/.google.cloud.datastream.v1alpha1.MysqlDatabase\"\226\001\n"
          + "\021MysqlSourceConfig\022?\n"
          + "\tallowlist\030\001 \001(\0132,.google.cloud.datastream.v1alpha1.MysqlRdbms\022@\n\n"
          + "rejectlist\030\002 \001(\0132,.google.cloud.datastream.v1alpha1.MysqlRdbms\"\375\001\n"
          + "\014SourceConfig\022+\n"
          + "\036source_connection_profile_name\030\001 \001(\tB\003\340A\002\022T\n"
          + "\024oracle_source_config\030d \001(\01324.google"
          + ".cloud.datastream.v1alpha1.OracleSourceConfigH\000\022R\n"
          + "\023mysql_source_config\030e \001(\01323.g"
          + "oogle.cloud.datastream.v1alpha1.MysqlSourceConfigH\000B\026\n"
          + "\024source_stream_config\"\020\n"
          + "\016AvroFileFormat\"\212\002\n"
          + "\016JsonFileFormat\022N\n"
          + "\022schema_file_format\030\001"
          + " \001(\01622.google.cloud.datastream.v1alpha1.SchemaFileFormat\022U\n"
          + "\013compression\030\002 \001(\0162@.google.cloud.datastream."
          + "v1alpha1.JsonFileFormat.JsonCompression\"Q\n"
          ...
          + "d.datastream.v1alpha1.GcsFileFormatB\002\030\001\022\030\n"
          + "\020file_rotation_mb\030\003 \001(\005\0229\n"
          + "\026file_rotation_interval\030\004 \001(\0132\031.google.protobuf.Duration\022L\n"
          + "\020avro_file_format\030d \001(\01320.google."
          + "cloud.datastream.v1alpha1.AvroFileFormatH\000\022L\n"
          + "\020json_file_format\030e \001(\01320.google.cl"
          + "oud.datastream.v1alpha1.JsonFileFormatH\000B\r\n"
          ...
          + "6.google.cloud.datastream.v1alpha1.GcsDestinationConfigH\000B\033\n"
          + "\031destination_stream_config\"\330\t\n"
          + "\006Stream\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\0224\n"
          + "\013create_time\030\002 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0224\n"
          + "\013update_time\030\003 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022D\n"
          + "\006labels\030\004 \003(\013"
          + "24.google.cloud.datastream.v1alpha1.Stream.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022J\n\r"
          + "source_config\030\006"
          + " \001(\0132..google.cloud.datastream.v1alpha1.SourceConfigB\003\340A\002\022T\n"
          + "\022destination_config\030\007 \001(\01323.google.cloud"
          + ".datastream.v1alpha1.DestinationConfigB\003\340A\002\022=\n"
          + "\005state\030\010 \001(\0162..google.cloud.datastream.v1alpha1.Stream.State\022T\n"
          + "\014backfill_all\030e"
          + " \001(\0132<.google.cloud.datastream.v1alpha1.Stream.BackfillAllStrategyH\000\022V\n\r"
          + "backfill_none\030f \001(\0132=.google.cloud.datastrea"
          + "m.v1alpha1.Stream.BackfillNoneStrategyH\000\022<\n"
          + "\006errors\030\t"
          + " \003(\0132\'.google.cloud.datastream.v1alpha1.ErrorB\003\340A\003\032\313\001\n"
          + "\023BackfillAllStrategy\022P\n"
          + "\027oracle_excluded_objects\030\001 \001(\0132"
          + "-.google.cloud.datastream.v1alpha1.OracleRdbmsH\000\022N\n"
          + "\026mysql_excluded_objects\030\002 \001(\013"
          + "2,.google.cloud.datastream.v1alpha1.MysqlRdbmsH\000B\022\n"
          ...
          + "com/Stream\0228projects/{project}/locations/{location}/streams/{stream}B\023\n"
          ...
          + "\007details\030\005"
          + " \003(\01324.google.cloud.datastream.v1alpha1.Error.DetailsEntry\032.\n"
          + "\014DetailsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"U\n"
          + "\020ValidationResult\022A\n"
          + "\013validations\030\001 \003(\013"
          + "2,.google.cloud.datastream.v1alpha1.Validation\"\206\002\n\n"
          + "Validation\022\023\n"
          + "\013description\030\001 \001(\t\022C\n"
          + "\006status\030\002"
          + " \001(\01623.google.cloud.datastream.v1alpha1.Validation.Status\022D\n"
          + "\007message\030\003"
          + " \003(\01323.google.cloud.datastream.v1alpha1.ValidationMessage\022\014\n"
          ...
          + "\005level\030\002"
          + " \001(\01629.google.cloud.datastream.v1alpha1.ValidationMessage.Level\022S\n"
          + "\010metadata\030\003 \003"
          + "(\0132A.google.cloud.datastream.v1alpha1.ValidationMessage.MetadataEntry\022\014\n"
          ...
          + "$com.google.cloud.datastream.v1alpha1B\035CloudDa"
