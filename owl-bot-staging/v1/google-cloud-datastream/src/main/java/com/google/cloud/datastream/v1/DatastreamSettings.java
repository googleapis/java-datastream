...
public class DatastreamSettings extends ClientSettings<DatastreamSettings> {
  ...
  public UnaryCallSettings<LookupStreamObjectRequest, StreamObject> lookupStreamObjectSettings() {
    return ((DatastreamStubSettings) getStubSettings()).lookupStreamObjectSettings();
  }
  ...
  public PagedCallSettings<
    ...
    return ((DatastreamStubSettings) getStubSettings()).listStreamObjectsSettings();
  }
  ...
  public UnaryCallSettings<StartBackfillJobRequest, StartBackfillJobResponse>
    ...
    return ((DatastreamStubSettings) getStubSettings()).startBackfillJobSettings();
  }
  ...
  public UnaryCallSettings<StopBackfillJobRequest, StopBackfillJobResponse>
    ...
    return ((DatastreamStubSettings) getStubSettings()).stopBackfillJobSettings();
  }
  ...
  public PagedCallSettings<ListLocationsRequest, ListLocationsResponse, ListLocationsPagedResponse>
    ...
    return ((DatastreamStubSettings) getStubSettings()).listLocationsSettings();
  }

  /** Returns the object with the settings used for calls to getLocation. */
  public UnaryCallSettings<GetLocationRequest, Location> getLocationSettings() {
    return ((DatastreamStubSettings) getStubSettings()).getLocationSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<DatastreamSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<GetStreamObjectRequest, StreamObject>
      ...
      return getStubSettingsBuilder().getStreamObjectSettings();
    }
    ...
    public UnaryCallSettings.Builder<LookupStreamObjectRequest, StreamObject>
      ...
      return getStubSettingsBuilder().lookupStreamObjectSettings();
    }
    ...
    public PagedCallSettings.Builder<
            ListStreamObjectsRequest, ListStreamObjectsResponse, ListStreamObjectsPagedResponse>
        listStreamObjectsSettings() {
      return getStubSettingsBuilder().listStreamObjectsSettings();
    }
    ...
    public UnaryCallSettings.Builder<StartBackfillJobRequest, StartBackfillJobResponse>
        startBackfillJobSettings() {
      return getStubSettingsBuilder().startBackfillJobSettings();
    }
    ...
    public UnaryCallSettings.Builder<StopBackfillJobRequest, StopBackfillJobResponse>
        stopBackfillJobSettings() {
      return getStubSettingsBuilder().stopBackfillJobSettings();
    }
