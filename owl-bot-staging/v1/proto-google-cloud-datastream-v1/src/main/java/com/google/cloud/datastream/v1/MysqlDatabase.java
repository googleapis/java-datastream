        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              mysqlTables_ = new java.util.ArrayList<com.google.cloud.datastream.v1.MysqlTable>();
              mutable_bitField0_ |= 0x00000001;
            }
            mysqlTables_.add(
                input.readMessage(com.google.cloud.datastream.v1.MysqlTable.parser(), extensionRegistry));
            break;
          }
          default: {
