        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              streamObjects_ = new java.util.ArrayList<com.google.cloud.datastream.v1.StreamObject>();
              mutable_bitField0_ |= 0x00000001;
            }
            streamObjects_.add(
                input.readMessage(com.google.cloud.datastream.v1.StreamObject.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.datastream.v1.ListStreamObjectsResponse) e.getUnfinishedMessage();
