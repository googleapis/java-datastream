        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              mysqlColumns_ = new java.util.ArrayList<com.google.cloud.datastream.v1alpha1.MysqlColumn>();
              mutable_bitField0_ |= 0x00000001;
            }
            mysqlColumns_.add(
                input.readMessage(com.google.cloud.datastream.v1alpha1.MysqlColumn.parser(), extensionRegistry));
            break;
          }
          default: {
